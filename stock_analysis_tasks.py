...
class StockAnalysisTasks():
  def research(self, agent, country):
    return Task(description=dedent(f"""
        ...
        releases, and market analyses related to {country}'s stocks and
        its industry.
  ...
  def financial_analysis(self, agent): 
    return Task(description=dedent(f"""
        Conduct a thorough analysis of stocks' financial
        health and market performance. 
        This includes examining key financial metrics such as
        P/E ratio, EPS growth, revenue trends, and 
        debt-to-equity ratio. 
        Also, analyze stocks' performance in comparison 
